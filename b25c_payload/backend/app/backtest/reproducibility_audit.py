...
def _candidate_snapshot(candidate: dict[str, Any], rank: int) -> dict[str, Any]:
    ...
    return {
        ...
        "strategy_trace": _json_safe(candidate.get("_repro_strategy_trace") or {}),
        ...
        "price_plan": {
            ...
            "target1_cap_applied": risk_plan.get("target1_cap_applied"),
            "target1_cap_price": risk_plan.get("target1_cap_price"),
            "structural_target1_price": risk_plan.get("structural_target1_price"),
            "structural_target1_basis": risk_plan.get("structural_target1_basis"),
            "target1_audit": _json_safe(risk_plan.get("target1_audit") or {}),
