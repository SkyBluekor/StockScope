...
assert(latestScannerDataDate(restored.result) === "2026-09-14", "latest EOD date should be selected from market data dates");
...
console.log("scannerSession v0.21.4-A.3 tests: PASS");
